"""
Run domain adversarial net for hashing, with unlabeled target data
"""
import os,pickle
import torch
...
from expr_suites.with_unlabeled.train_logic import do_forward_pass
...
params.target_data_path = "F:/data/mnist_m/mini/train" # target data are used as unlabeled
