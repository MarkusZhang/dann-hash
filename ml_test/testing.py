...
from ml_test.testing_utils import _get_data_loader, _construct_hash_function, _create_label_hash_dicts, _load_models_from_path, _save_hash_code

# ml_test hashing performance
def testing(params,models,query_data_loader,db_data_loader):
    """
    ...
    hash_model = _construct_hash_function(models=models,params=params)
...
def run_simple_test(params,saved_model_path, save_hash_to=None,model_def=sinno_model):
